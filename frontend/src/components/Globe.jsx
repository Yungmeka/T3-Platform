...
function projectPt(x, y, z, cx, cy, fov) {
...
export default function Globe({
  ...
  const draw = useCallback(() => {
    ...
    innerGrad.addColorStop(0, 'rgba(139, 92, 246, 0.02)');
    innerGrad.addColorStop(1, 'rgba(139, 92, 246, 0.005)');
    ...
    for (const conn of connections) {
      ...
      const [sx1, sy1] = projectPt(x1, y1, z1, cx, cy, fov);
      const [sx2, sy2] = projectPt(x2, y2, z2, cx, cy, fov);
      ...
      const [scx, scy] = projectPt(elevX, elevY, elevZ, cx, cy, fov);
      ...
      // Glow on traveling dot
      const dotGlow = ctx.createRadialGradient(tx, ty, 0, tx, ty, 8);
      dotGlow.addColorStop(0, 'rgba(192, 132, 252, 0.3)');
      dotGlow.addColorStop(1, 'rgba(192, 132, 252, 0)');
    ...
    for (const marker of markers) {
      ...
      const coreGrad = ctx.createRadialGradient(sx, sy, 0, sx, sy, 3);
      coreGrad.addColorStop(0, 'rgba(236, 72, 153, 1)');
      coreGrad.addColorStop(1, 'rgba(139, 92, 246, 1)');
